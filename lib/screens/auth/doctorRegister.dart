...
class _RegisterState extends State<DoctorRegister> {
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            TextFormField(
              ...
              textInputAction: TextInputAction.next,
              validator: (value) {
                if (value!.isEmpty) return 'Please enter the Open Hour';
                return null;
              },
            ),
            SizedBox(
            ...
            TextFormField(
              ...
              textInputAction: TextInputAction.next,
              validator: (value) {
                if (value!.isEmpty) return 'Please enter the Close Hour';
                return null;
              },
            ),
            SizedBox(
            ...
            TextFormField(
              ...
              textInputAction: TextInputAction.next,
              validator: (value) {
                if (value!.isEmpty) return 'Please enter the Speciality';
                return null;
              },
            ),
            SizedBox(
  ...
  void _registerAccount() async {
    ...
    if (user != null) {
      ...
      DoctorModel model = DoctorModel(name: _displayName.text,email: user.email,openHour: openHour.text,closeHour: closeHour.text,address: city.text,userType: 'doctor',rating: 0.0,uid: user.uid,profileImageUrl: image,type: speciality.text,contactNo: phone.text);
      FirebaseFirestore.instance.collection('doctors').doc(user.uid).set(model.toJson(), SetOptions(merge: true));
