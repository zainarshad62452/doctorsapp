import 'dart:async';
import 'dart:ui';
import 'package:doctorsapp/screens/user/chatbot.dart';
...
import '../doctor/adminLiveChatSupport.dart';
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                          ...
                          child: MaterialButton(
                            onPressed: () {
                              if(cards[index].doctor == "Search Hospital"){
                                Get.to(()=>NearbyHospitalsPage());
                              }else if(cards[index].doctor == "Find & Book Appointment") {
                                Get.to(() => DoctorsList());
                              }else if(cards[index].doctor == "Nuritions") {
                                Get.to(() => NutritionsScreen());
                              }else if(cards[index].doctor == "Video Consulation"){
                                Get.to(()=>MyAppointments(title: "Video Consultation",));
                              }else{
                                if(FirebaseAuth.instance.currentUser!.email == kAdminEmail){
