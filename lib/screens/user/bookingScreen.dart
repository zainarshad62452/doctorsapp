...
class _BookingScreenState extends State<BookingScreen> {
    ...
    Widget okButton = TextButton(
      ...
      onPressed: () {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => MyAppointments(title: "My Appointments",),
          ),
        );
      },
    );
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          if (value!.isEmpty) {
                            ...
                            return 'Please Enter correct Phone number of 11 characters like 03123456789';
                          }
                          return null;
                        },
                        onFieldSubmitted: (String value) {
  ...
  Future<void> _createAppointment() async {
   ...
   final newUser = FirebaseFirestore.instance
    ...
    final allAppointment = FirebaseFirestore.instance
        .collection('AllAppointments')
        .doc();
        allAppointment.set({
      'name': _nameController.text,
      'id': allAppointment.id,
      'phone': _phoneController.text,
      'description': _descriptionController.text,
      'doctor': _doctorController.text,
          'appointmentType': _selectedAppointmentType,
