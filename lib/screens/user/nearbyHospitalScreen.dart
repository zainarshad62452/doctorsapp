...
class _NearbyHospitalsPageState extends State<NearbyHospitalsPage> {
  ...
  Future<List<Hospital>> searchHospitals(LatLng latLng) async {
    String apiKey = kGoogleApiKey;
    String baseUrl = 'https://maps.googleapis.com/maps/api/place/nearbysearch/json';
    String location = '${latLng.latitude},${latLng.longitude}';
    String radius = '5000'; // Search radius in meters
    String type = 'hospital'; // Restrict results to hospitals
  ...
  void updateMarkers(LatLng latLng) async {
    List<Hospital> hospitals = await searchHospitals(latLng);
